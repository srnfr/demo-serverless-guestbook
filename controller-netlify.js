...
RedisController.prototype.onRedis = function() {
    ...
    this.http_.get("/netlify/functions/guestbook.php?cmd=set&key=messages&value=" + value)
...
redisApp.controller('RedisCtrl', function ($scope, $http, $location) {
        ...
        $scope.controller.http_.get("/netlify/functions/guestbook.php?cmd=get&key=messages")
